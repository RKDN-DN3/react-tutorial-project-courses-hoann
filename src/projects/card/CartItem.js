    ...
    return (
        <article className={cx('cart-item')}>
            ...
            <div>
                ...
                <button className={cx('remove-btn')} onClick={() => remove(id)}>
                    remove
                </button>
            </div>
            <div>
                <button className={cx('amount-btn')} onClick={() => toggleAmount(id, 'inc')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width={'2rem'} viewBox="0 0 20 20">
                        <path d="M10.707 7.05L10 6.343 4.343 12l1.414 1.414L10 9.172l4.243 4.242L15.657 12z" />
                    </svg>
                </button>
                <p className={cx('amount')}> {amount}</p>
                <button className={cx('amount-btn')} onClick={() => toggleAmount(id, 'dec')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width={'2rem'} viewBox="0 0 20 20">
