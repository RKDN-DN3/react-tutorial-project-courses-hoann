...
const publicRoutes = [
    ...
    { path: routes.tours, component: Tours, name: 'Tours', img: tours_thumb, type: 'basic', display: true },
    { path: routes.reviews, component: Reviews, name: 'Reviews', img: reviews_thumb, type: 'basic', display: true },
    {
    ...
    { path: routes.menu, component: Menu, name: 'Menu', img: menu_thumb, type: 'basic', display: true },
    { path: routes.tabs, component: Tabs, name: 'Tabs', img: tabs_thumb, type: 'basic', display: true },
    { path: routes.slider, component: Slider, name: 'Slider', img: slider_thumb, type: 'basic', display: true },
    { path: routes.lorem, component: Lorem, name: 'Lorem', img: lorem_thumb, type: 'basic', display: true },
    { path: routes.color, component: Color, name: 'Color Genarate', img: color_thumb, type: 'basic', display: true },
    { path: routes.grocery, component: Grocery, name: 'Grocery Bud', img: grocery_thumb, type: 'basic', display: true },
    { path: routes.navbar, component: Navbar, name: 'Navbar', img: navbar_thumb, type: 'basic', display: true },
    {
        path: routes.sidebar,
        component: Sidebar,
    ...
    { path: routes.stripe, component: Stripe, name: 'Stripe Menu', img: stripe_thumb, type: 'basic', display: true },
    { path: routes.card, component: Card, name: 'Card', img: card_thumb, type: 'basic', display: true },
    {
